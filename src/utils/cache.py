...
class ProteinCache:
    ...
    def get_kegg_entries_batch(
        self, identifiers: List[str]
    ) -> Dict[str, Optional[KeggEntry]]:
        """
    ...
    def clear_expired_cache(self):
        ...
        print(
            f"Removed {len(expired_ncbi)} expired NCBI entries and {len(expired_kegg)} expired KEGG entries"
        )
